...
from SteamLitUI.Chatbot_UI import LaunchUI
import base64
...
if __name__ == "__main__":
    ...
    # as of now it is fixed we can change them later to set it as dynamuc
    selected_section = "Knowledge Management"
    selected_page = "Database Chatbot"
